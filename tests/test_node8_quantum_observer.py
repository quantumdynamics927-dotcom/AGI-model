...
# Now, import the necessary node classes for the integration test
from quantum_observer.node8_chain_monitor import Node8QuantumObserver
...
class TestNode8QuantumObserver(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.observer = Node8QuantumObserver(nft_layer_node=self.node4, qvae_bridge_node=self.node9)
    ...
    def test_on_mint_event_triggers_notification(self):
        ...
        self.assertEqual(len(self.observer.notifications), initial_notification_count + 1)
    ...
    def test_detect_quantum_collapse_logic(self):
        ...
        self.assertTrue(self.observer.detect_quantum_collapse(collapsed_job_id, collapse_threshold=0.9))
        ...
        self.assertFalse(self.observer.detect_quantum_collapse(superposed_job_id, collapse_threshold=0.9))
